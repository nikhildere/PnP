...
namespace Provisioning.Common.Data.SiteRequests.Impl
{
    ...
    internal class SPSiteRequestManager : AbstractModule, ISiteRequestManager, ISharePointClientService
    {
        ...
        //const string CAML_APPROVEDREQUESTS = "<View><Query><Where><In> <FieldRef Name='ID'/> <Values> <Value Type='Number'>7463</Value> </Values> </In></Where></Query><RowLimit>100</RowLimit></View>";
